...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    tok_identifier = 264,          /* tok_identifier  */
    tok_double_literal = 265,      /* tok_double_literal  */
    tok_string_literal = 266,      /* tok_string_literal  */
    tok_int_literal = 267          /* tok_int_literal  */
  };
